...
static IRInstructionType instruction_typ_from_binary_op(BinaryOpType op_type)
{
  ...
  case BINARY_OP_TYPE_BITWISE_AND: MCC_UNIMPLEMENTED();
  case BINARY_OP_TYPE_BITWISE_OR: MCC_UNIMPLEMENTED();
  case BINARY_OP_TYPE_BITWISE_XOR: MCC_UNIMPLEMENTED();
  case BINARY_OP_TYPE_BITWISE_LEFT_SHIFT: MCC_UNIMPLEMENTED();
  case BINARY_OP_TYPE_BITWISE_RIGHT_SHIFT: MCC_UNIMPLEMENTED();
  }
  MCC_UNREACHABLE();
}
